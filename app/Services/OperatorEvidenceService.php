...
class OperatorEvidenceService
{
    ...
    private function compactGenealogyEvidenceSprintHeadline(array $sections): array
    {
        ...
        return [
            ...
            'operator_touched_packets' => (int) ($counts['operator_touched_packets'] ?? 0),
            'operator_touched_preview_only_packets' => (int) ($counts['operator_touched_preview_only_packets'] ?? 0),
            'terminal_outcome_packets' => (int) ($counts['terminal_outcome_packets'] ?? 0),
            'followup_outcome_packets' => (int) ($counts['followup_outcome_packets'] ?? 0),
            'reviewed_preview_only' => (int) ($counts['reviewed_preview_only'] ?? 0),
            'rejected_packets' => (int) ($counts['rejected_packets'] ?? 0),
            'deferred_packets' => (int) ($counts['deferred_packets'] ?? 0),
            'clarification_requested' => (int) ($counts['clarification_requested'] ?? 0),
    ...
    private function collectGenealogyEvidenceSprint(Carbon $sampledAt): array
    {
        ...
        try {
            ...
            $status = match ($sourceStatus) {
                'ready_for_review', 'operator_pass_recorded' => 'healthy',
                'blocked' => 'blocked',
