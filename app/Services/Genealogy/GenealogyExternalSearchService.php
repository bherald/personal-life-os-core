...
class GenealogyExternalSearchService
{
    ...
    public function searchDAR(array $params): array
    {
        ...
        return $this->execSearXNG('dar', implode(' ', $parts), $params, [
            ...
            'dar_db_url'  => 'https://services.dar.org/Public/DAR_Member_Data/search_patriot_ancestors.cfm?LastName=' . urlencode($params['surname'] ?? ''),
            'source_name' => 'DAR Genealogical Records',
            'note'        => 'DAR Patriot Index covers verified Revolutionary War patriots. Free search of patriot ancestor database.',
        ]);
    }
    ...
    public function searchGermanChurchRecords(array $params): array
    {
        ...
        return $this->execSearXNG('german_church_records', implode(' ', $parts), $params, [
            ...
            'note'             => 'Archion: German Protestant church books. Matricula: German/Austrian/Swiss Catholic records. Both free to browse.',
