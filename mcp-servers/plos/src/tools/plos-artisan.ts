...
export const ALLOWED_COMMANDS: Record<string, { description: string; timeout: number }> = {
  ...
  'ops:review-backlog-report --json --next-target --focus=typed-remediation': { description: 'Read-only sanitized typed-remediation review target JSON', timeout: 30_000 },
  'ops:review-backlog-report --json --next-target --focus=materializable-remediation': { description: 'Read-only sanitized materializable remediation review target JSON', timeout: 30_000 },
