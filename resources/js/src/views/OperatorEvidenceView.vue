...
const SECTION_DEFINITIONS = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Categories', path: 'counts.recommendation_category_counts', format: formatKeyValues },
    ],
  },
  {
    key: 'dba_telemetry',
  ...
  {
    key: 'file_lifecycle_reconciliation',
    title: 'File Lifecycle Reconciliation',
    code: 'Move/delete evidence',
    metrics: [
      { label: 'Active Files', path: 'counts.active_files' },
      { label: 'Missing Identity', path: 'counts.active_missing_identity_or_path' },
      { label: 'Asset Conflicts', path: 'counts.duplicate_asset_groups' },
      { label: 'FileID Conflicts', path: 'counts.duplicate_fileid_groups' },
      { label: 'Content Multi-Path', path: 'counts.same_content_multi_path_groups' },
      { label: 'Move Candidates', path: 'counts.same_filename_content_multi_path_groups' },
      { label: 'MySQL Orphans', path: 'counts.mysql_downstream_orphan_rows' },
      { label: 'RAG Docs', path: 'counts.rag_file_documents' },
      { label: 'RAG ID Checked', path: 'counts.rag_source_id_checked_sample' },
      { label: 'RAG ID Missing', path: 'counts.rag_source_id_missing_registry_in_sample' },
      { label: 'RAG UUID Checked', path: 'counts.rag_uuid_checked_sample' },
      { label: 'RAG UUID Missing', path: 'counts.rag_uuid_missing_registry_in_sample' },
      { label: 'Writes Enabled', path: 'counts.writes_enabled', format: formatBoolean },
      { label: 'Move Apply', path: 'counts.move_apply_enabled', format: formatBoolean },
      { label: 'Delete Apply', path: 'counts.delete_apply_enabled', format: formatBoolean },
      { label: 'Canonical Writeback', path: 'counts.canonical_writeback_enabled', format: formatBoolean },
    ],
  },
  {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Locator Required', path: 'counts.source_locator_required_packets' },
      { label: 'Manual-Only Sources', path: 'counts.manual_only_source_packets' },
      { label: 'Source Realism Blocks', path: 'counts.source_realism_blocked_packets' },
      ...
      { label: 'Pass Remaining', path: 'counts.operator_pass_gap_remaining_to_pass' },
      { label: 'Outcome Gap', path: 'counts.operator_pass_gap_remaining_outcomes' },
      { label: 'Safe-Touch Gap', path: 'counts.operator_pass_gap_remaining_touched_preview_only' },
      { label: 'Pass Boundary Gap', path: 'counts.operator_pass_gap_remaining_boundary' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Tools Unavailable', path: 'counts.tools_unavailable_total' },
      { label: 'Tools Degraded', path: 'counts.tools_degraded_total' },
      ...
      { label: 'Undistilled Sessions', path: 'counts.memory_undistilled_sessions_window' },
      { label: 'Undistilled Tokens', path: 'counts.memory_undistilled_tokens_window' },
      { label: 'Oldest Undistilled', path: 'counts.memory_oldest_undistilled_age_hours', format: formatHours },
      { label: 'Low-Signal Memory', path: 'counts.memory_low_signal_undistilled_sessions_window' },
      { label: 'Debt Buckets', path: 'counts.memory_undistilled_age_buckets', format: formatKeyValues },
      ...
      { label: 'Non-ASCII Markers', path: 'counts.scheduled_non_ascii_output_runs_window' },
      { label: 'Guarded Output', path: 'counts.scheduled_guarded_output_runs_window' },
      { label: 'Latest Empty Output', path: 'counts.scheduled_latest_empty_success_output_at', format: formatTimestamp },
      { label: 'Empty Output Age', path: 'counts.scheduled_latest_empty_success_output_age_hours', format: formatHours },
      { label: 'Latest CJK Signal', path: 'counts.scheduled_latest_cjk_output_at', format: formatTimestamp },
      { label: 'CJK Signal Age', path: 'counts.scheduled_latest_cjk_output_age_hours', format: formatHours },
      { label: 'Latest Non-ASCII', path: 'counts.scheduled_latest_non_ascii_output_at', format: formatTimestamp },
      { label: 'Non-ASCII Age', path: 'counts.scheduled_latest_non_ascii_output_age_hours', format: formatHours },
      { label: 'Latest Guarded Output', path: 'counts.scheduled_latest_guarded_output_at', format: formatTimestamp },
      { label: 'Guarded Output Age', path: 'counts.scheduled_latest_guarded_output_age_hours', format: formatHours },
      { label: 'Failure Modes', path: 'counts.failure_mode_counts', format: formatKeyValues },
      { label: 'Top Failure Modes', path: 'counts.top_failure_modes' },
  ...
  {
    key: 'agent_doctor_history',
    title: 'Agent Doctor History',
    code: 'Snapshot trends',
    metrics: [
      { label: 'Snapshots', path: 'counts.snapshot_count' },
      { label: 'Latest', path: 'counts.latest_status' },
      { label: 'Trend', path: 'counts.trend' },
      { label: 'Captured', path: 'counts.latest_captured_at', format: formatTimestamp },
      { label: 'Status Counts', path: 'counts.status_counts', format: formatKeyValues },
      { label: 'Warnings', path: 'counts.latest_warning_count' },
      { label: 'Critical', path: 'counts.latest_critical_count' },
      { label: 'Warning Delta', path: 'counts.warning_delta' },
      { label: 'Critical Delta', path: 'counts.critical_delta' },
      { label: 'Agent Delta', path: 'counts.agent_count_delta' },
      { label: 'Latest Failure Modes', path: 'counts.latest_failure_modes', format: formatKeyValues },
      { label: 'Mode Delta Status', path: 'counts.failure_mode_delta_status' },
      { label: 'Mode Coverage', path: 'counts.failure_mode_coverage_percent' },
      { label: 'Mode Snapshots', path: 'counts.failure_mode_snapshot_count' },
      { label: 'Failure Mode Deltas', path: 'counts.failure_mode_deltas', format: formatKeyValues },
      { label: 'Rising Modes', path: 'counts.top_rising_failure_modes', format: formatKeyValues },
      { label: 'Falling Modes', path: 'counts.top_falling_failure_modes', format: formatKeyValues },
      { label: 'Trace', path: 'counts.trace_status' },
      { label: 'Trace Events', path: 'counts.trace_events_24h' },
      { label: 'Trace Delta', path: 'counts.trace_events_24h_delta' },
      { label: 'Recursion', path: 'counts.recursion_status' },
      { label: 'Recursion Calls', path: 'counts.recursion_calls_7d' },
      { label: 'Recursion Delta', path: 'counts.recursion_calls_7d_delta' },
      { label: 'Non-ASCII Markers', path: 'counts.scheduled_non_ascii_output_runs_window' },
      { label: 'Guarded Output', path: 'counts.scheduled_guarded_output_runs_window' },
      { label: 'Scope', path: 'counts.posture_scope' },
      { label: 'Snapshot IDs', path: 'counts.snapshot_ids_included', format: formatBoolean },
      { label: 'Check IDs', path: 'counts.check_ids_included', format: formatBoolean },
      { label: 'Per-Agent Details', path: 'counts.per_agent_details_included', format: formatBoolean },
      { label: 'Raw Traces', path: 'counts.raw_traces_included', format: formatBoolean },
      { label: 'Prompts/Completions', path: 'counts.prompts_or_completions_included', format: formatBoolean },
      { label: 'Filesystem Paths', path: 'counts.filesystem_paths_included', format: formatBoolean },
    ],
  },
  {
    key: 'agent_tool_policy_telemetry',
    title: 'Agent Tool Policy',
    code: 'Registry telemetry',
    metrics: [
      { label: 'Stale Window', path: 'counts.stale_hours', format: formatHours },
      { label: 'Tools', path: 'counts.tools_total' },
      { label: 'Enabled', path: 'counts.enabled_total' },
      { label: 'Disabled', path: 'counts.disabled_total' },
      { label: 'Unavailable', path: 'counts.enabled_unavailable_total' },
      { label: 'Degraded', path: 'counts.enabled_degraded_total' },
      { label: 'Unknown Availability', path: 'counts.enabled_unknown_availability_total' },
      { label: 'Recent Freshness', path: 'counts.freshness_recent_total' },
      { label: 'Stale Enabled', path: 'counts.freshness_stale_enabled_total' },
      { label: 'Unchecked Enabled', path: 'counts.freshness_unchecked_enabled_total' },
      { label: 'Privacy Unspecified', path: 'counts.privacy_unspecified_enabled_total' },
      { label: 'Policy Gaps', path: 'counts.policy_gap_enabled_total' },
      { label: 'Last Error', path: 'counts.last_error_enabled_total' },
      { label: 'Oldest Check', path: 'counts.oldest_checked_age_hours', format: formatHours },
      { label: 'Private Allowed', path: 'counts.allows_private_data_total' },
      { label: 'Private Denied', path: 'counts.denies_private_data_total' },
      { label: 'Result Limit Missing', path: 'counts.max_result_bytes_missing_enabled_total' },
      { label: 'Availability', path: 'counts.availability_counts', format: formatKeyValues },
      { label: 'Privacy Classes', path: 'counts.privacy_class_counts', format: formatKeyValues },
      { label: 'Risk Levels', path: 'counts.risk_level_counts', format: formatKeyValues },
    ],
  },
  {
    key: 'review_backlog',
    ...
    metrics: [
      ...
      { label: 'Packet Identity', path: 'counts.packet_identity_present_rows' },
      { label: 'Packet Privacy', path: 'counts.packet_privacy_cleared_rows' },
      { label: 'Packet Validation', path: 'counts.packet_validation_valid_rows' },
      ...
      { label: 'Packet Self-Check', path: 'counts.packet_self_check_status' },
      { label: 'Packet Score %', path: 'counts.packet_self_check_score_percent' },
      { label: 'Packet Gate Gaps', path: 'counts.packet_self_check_gate_gap_count' },
      { label: 'Packet Gap Types', path: 'counts.packet_self_check_gap_counts', format: formatKeyValues },
      ...
      { label: 'Source Packet Identity', path: 'counts.next_safe_handoffs.source_backed_packet.packet_identity_present', format: formatBoolean },
      { label: 'Source Packet Privacy', path: 'counts.next_safe_handoffs.source_backed_packet.packet_privacy_cleared', format: formatBoolean },
      { label: 'Source Packet Validation', path: 'counts.next_safe_handoffs.source_backed_packet.packet_validation_valid', format: formatBoolean },
      { label: 'Source Packet Conflict', path: 'counts.next_safe_handoffs.source_backed_packet.packet_conflict_evidence_present', format: formatBoolean },
      { label: 'Source Packet Negative', path: 'counts.next_safe_handoffs.source_backed_packet.packet_negative_evidence_present', format: formatBoolean },
      { label: 'Source Packet Locator', path: 'counts.next_safe_handoffs.source_backed_packet.packet_locator_present', format: formatBoolean },
      { label: 'Source Packet Claim', path: 'counts.next_safe_handoffs.source_backed_packet.packet_extracted_claim_present', format: formatBoolean },
      ...
      { label: 'Remediation Candidates', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.candidate_rows' },
      { label: 'Remediation Ready Rows', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.materializable_rows' },
      { label: 'Remediation Validation', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.validation_blocked_rows' },
      { label: 'Remediation Unsupported', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.unsupported_operation_rows' },
      { label: 'Remediation Needs IDs', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.without_materialized_ids_rows' },
      { label: 'Remediation Missing', path: 'counts.next_safe_handoffs.materializable_remediation.focus_summary.missing_materialization_input_counts', format: formatKeyValues },
      { label: 'Typed Handoff', path: 'counts.next_safe_handoffs.typed_remediation.available', format: formatBoolean },
      { label: 'Typed State', path: 'counts.next_safe_handoffs.typed_remediation.query_state' },
      { label: 'Typed Status', path: 'counts.next_safe_handoffs.typed_remediation.materialization_status' },
      { label: 'Typed Blocked', path: 'counts.next_safe_handoffs.typed_remediation.validation_blocked', format: formatBoolean },
      { label: 'Typed Blockers', path: 'counts.next_safe_handoffs.typed_remediation.validation_blocker_count' },
      { label: 'Typed Codes', path: 'counts.next_safe_handoffs.typed_remediation.validation_blocker_codes' },
      { label: 'Typed Apply Held', path: 'counts.next_safe_handoffs.typed_remediation.apply_held', format: formatBoolean },
      { label: 'Aged Handoff', path: 'counts.next_safe_handoffs.aged_review.available', format: formatBoolean },
      { label: 'Aged State', path: 'counts.next_safe_handoffs.aged_review.query_state' },
      { label: 'Aged Selection', path: 'counts.next_safe_handoffs.aged_review.selection_reason' },
      { label: 'Aged Age Days', path: 'counts.next_safe_handoffs.aged_review.age_days' },
      { label: 'Aged Age Bucket', path: 'counts.next_safe_handoffs.aged_review.age_bucket' },
      { label: 'Aged Candidates', path: 'counts.next_safe_handoffs.aged_review.focus_summary.candidate_rows' },
      { label: 'Aged Stale Rows', path: 'counts.next_safe_handoffs.aged_review.focus_summary.stale_rows' },
      { label: 'Aged High Priority', path: 'counts.next_safe_handoffs.aged_review.focus_summary.high_priority_rows' },
      { label: 'Aged Buckets', path: 'counts.next_safe_handoffs.aged_review.focus_summary.age_bucket_counts', format: formatKeyValues },
      { label: 'Aged Classes', path: 'counts.next_safe_handoffs.aged_review.focus_summary.classification_counts', format: formatKeyValues },
      { label: 'Recommendations', path: 'counts.recommendations' },
    ],
  },
  {
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Named Photo Dates', path: 'counts.named_only_photo_date_available' },
      { label: 'Named Missing Dates', path: 'counts.named_only_photo_date_missing' },
      { label: 'Open Photo Dates', path: 'counts.open_named_only_photo_date_available' },
      { label: 'Open Missing Dates', path: 'counts.open_named_only_photo_date_missing' },
      ...
      { label: 'Oldest Pending', path: 'counts.oldest_pending_age_hours', format: formatHours },
      { label: 'Named Next State', path: 'counts.named_only_next_action.state', format: formatRuntimeState },
      { label: 'Named Next Reason', path: 'counts.named_only_next_action.reason', format: formatRuntimeState },
      { label: 'Named Next Action', path: 'counts.named_only_next_action.action_label' },
      { label: 'Named Automation', path: 'counts.named_only_next_action.automation_allowed', format: formatBoolean },
      { label: 'Named New Person', path: 'counts.named_only_next_action.create_person_allowed', format: formatBoolean },
      { label: 'Named Writeback', path: 'counts.named_only_next_action.writeback_allowed', format: formatBoolean },
      { label: 'Named Row Selectors', path: 'counts.named_only_next_action.row_selectors_included', format: formatBoolean },
    ],
  },
  {
