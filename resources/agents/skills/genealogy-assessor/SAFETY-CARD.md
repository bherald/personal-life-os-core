...
**Capabilities:** Survey tree health, missing-data backlog, recent searches, source coverage, and open tasks. Prioritize persons for follow-up research and create research tasks.
